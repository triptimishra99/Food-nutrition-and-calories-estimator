...
class Ui_Form(object):
    def setupUi(self, Form):
        Form.setObjectName("Diabetes Prediction based on BMI")
        Form.resize(611, 536)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Diabetes Prediction based on BMI"))
        self.labelTitre.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:09pt; text-decoration: underline; color:#660000;\">Diabetes Prediction based on BMI</span></p></body></html>"))
